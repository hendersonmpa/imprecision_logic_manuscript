...
\label{sec:org791d38a}
Funding: None.
\section*{Author Declarations}
\label{sec:org4e8c772}
\begin{description}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{./figures/galtthresholdsv2.pdf}
