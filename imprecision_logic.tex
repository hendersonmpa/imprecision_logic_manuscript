...
\begin{frame}[label={sec:orgaf9508a}]{Software}
...
\ref{fig:org890f84d}) are the number of samples that will require repeat
...
(Figure \ref{fig:orgf17eb9e}). The "imprecision zone" is the region outside
...
threshold) (Figure \ref{fig:orgf17eb9e}, gold area). 
...
\(\sim\) 10 samples in the grey zone (Figure \ref{fig:orgf17eb9e} grey area)
annually with \(\sim\) 15 samples in the "imprecision zone" (Figure
\ref{fig:orgf17eb9e}, joint probablity based on red and gold areas). In
...
\label{sec:orgcdd1895}
Funding: None.
\section*{Author Declarations}
\label{sec:org147760c}
\begin{description}
